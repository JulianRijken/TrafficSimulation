...
namespace TrafficSimulation
{
    public class CarWheel : MonoBehaviour
    {
        ...
        [Header("Grip")] [SerializeField] private float _wheelMass = 20.0f;
        ...
        [FormerlySerializedAs("_breakingForce")] [Header("Breaking")] [SerializeField]
        private float _maxBreakingForce = 10.0f;
        ...
        private void HandleBreaking()
        {
            ...
            _connectedRigidbody.AddForceAtPosition(WheelForward * (brakingForce * Mathf.Sign(wheelBackwardsVelocity)),
                _wheelVisual.position);
        }
