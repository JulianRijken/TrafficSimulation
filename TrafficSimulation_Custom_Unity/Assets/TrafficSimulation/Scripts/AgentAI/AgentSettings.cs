...
namespace TrafficSimulation
{
    ...
    {
        [Header("Steering")] public PIDController.PIDSettings SteeringPIDSettings;

        [Header("Steering Smoothing")] public float PathSmoothingDefaultDistance = 5.0f;
        public float PathSmoothingDistanceOverSpeed = 0.15f;

        [Header("Steering Correction")] public bool UseDistanceCorrection = true;
        ...
        public PIDController.PIDSettings
            StopPointPIDSettings; //TODO: Should have a separate one for the break and throttle
        ...
        [Header("Power Speed Limit")] public float SpeedLimitInputMaxChangeRate = 1.5f;
        public float SpeedLimitThrottleProportionalGain = 0.15f;
        public float SpeedLimitBrakeProportionalGain = 0.10f;

        [Header("Collision Avoidance")] public float FrontSensorDefaultDistance = 5f;
        ...
        [Header("Intersection")] public float MaxTimeInIntersection = 5.0f;


        [Header("Debug")] public bool DebugAgentSize = false;
        ...
        [Header("Debug Colors")] public Color DebugAgentSizeWireColor = Color.red;
        ...
        public Color DebugPathCastSensorColor = Color.white;

        [Header("Debug Sizes")] public float DebugPathSmoothingBallRadius = 0.5f;
    }
}
