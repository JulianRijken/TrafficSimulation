...
namespace TrafficSimulation
{
    public class TrafficAgent : MonoBehaviour
    {
        ...
        public Intersection.Turn CurrentTurn { get; set; }
        ...
        private void Update()
        {
            ...
            if (_settings.UseFrontSensor)
            {
                ...
                if (_senseReactionTimer >= _senseReactionSpeed)
                {
                    ...
                    _senseReactionSpeed =
                        Random.Range(_settings.SensingReactionSpeed.x, _settings.SensingReactionSpeed.y);
                }
            }
            else
            {
            ...
            if (_timeSpentInIntersection >= _settings.MaxTimeInIntersection)
            {
                ...
                CurrentIntersection.RemoveAgentFromIntersection(this);
            }
        }
        ...
        private void UpdateSegment()
        {
            ...
            {
                // TODO: Should be done with events, the intersection should handle this
                CurrentIntersection.RemoveAgentFromIntersection(this);
            }
        }
        ...
        public Segment.Sample SampleFromDistanceExtended(float distanceAlongPath)
        {
            ...
            if (distanceAlongPath <= _currentSegment.TotalLength + distanceToNextSegment)
            {
                ...
                return Segment.Sample.Interpolate(fromSample, toSample,
                    distanceAlongPath - _currentSegment.TotalLength);
            }
        ...
        private void UpdateCurrentExtendedSample(Vector3 position)
        {
            ...
            if (_currentExtendedSample.IsAtEndOfSegment)
            {
                ...
                _currentExtendedSample.DirectionRight =
                    Vector3.Cross(_currentExtendedSample.DirectionForward, Vector3.up);
